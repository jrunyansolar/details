...
?>
    ...
    <label for="test"><?= $productOption->name; ?></label> 
    <div class="form-group">
    <select data-selected-text-format="count" title="Choose one of the following..."  class="form-control selectpicker show-menu-arrow" id="field-po-<?= $productOption->id; ?>" data-id="<?= $productOption->id;?>" name="field-po-<?= $productOption->id; ?>"
        multiple>
