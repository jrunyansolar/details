    ...
    <div class="row">
        <div class="col-md-12">
            <nav class="large-3 medium-4 columns" id="actions-sidebar">
                <ul class="side-nav list-unstyled list-inline">
                    <li><?= $this->Html->link(__('New Product Option'), ['action' => 'add'], ['class'=>'btn btn-primary']) ?></li>
                    <li><?= $this->Html->link(__('List Options'), ['controller' => 'Options', 'action' => 'index'], ['class'=>'btn btn-primary']) ?></li>
                    <li><?= $this->Html->link(__('New Option'), ['controller' => 'Options', 'action' => 'add'], ['class'=>'btn btn-primary']) ?></li>
                    <li><?= $this->Html->link(__('List Products'), ['controller' => 'Products', 'action' => 'index'], ['class'=>'btn btn-primary']) ?></li>
                    <li><?= $this->Html->link(__('New Product'), ['controller' => 'Products', 'action' => 'add'], ['class'=>'btn btn-primary']) ?></li>
                </ul>
            </nav>
