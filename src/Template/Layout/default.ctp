...
<head>
    ...
    <?= $this->fetch('script') ?>
    <?= $this->Html->meta('icon') ?>
    <?= $this->Html->css(['style.css','bootstrap.paper.min.css', '//cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4/css/bootstrap-select.min.css',
    '//netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap-glyphicons.css','//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css','//fonts.googleapis.com/css?family=Raleway:500i|Roboto:300,400,700|Roboto+Mono']) ?>
