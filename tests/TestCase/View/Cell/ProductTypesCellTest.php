...
use App\View\Cell\ProductTypesCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\ProductTypesCell Test Case
 */
class ProductTypesCellTest extends TestCase
{
     ...
     * Test subject
     *
     * @var \App\View\Cell\ProductTypesCell
     */
    public $ProductTypes;
    ...
    public function setUp()
    {
        ...
        $this->ProductTypes = new ProductTypesCell($this->request, $this->response);
    }
